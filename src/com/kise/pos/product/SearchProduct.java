...
public class SearchProduct extends JInternalFrame {
    ...
    Statement statement;
    ResultSet resultSet;
    public SearchProduct(Connection connection) {

        super("Search Product", false, true, true, true);
        ...
        txtProductVendor.setEditable(false);
        gridBagConstraints.anchor = GridBagConstraints.WEST;
        gridBagConstraints.fill = GridBagConstraints.BOTH;
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
