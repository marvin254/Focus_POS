...
public class UpdateEmployee extends JInternalFrame {
    ...
    JTextField txtSearch, txtEmployeeID, txtEmployeeName, txtEmployeeEmail, txtEmployeePhone, txtEmployeeGender, txtEmployeeJobTitle;
    ...
    public UpdateEmployee(Connection connection) {
        ...
        btnUpdate.addActionListener(e -> {
            ...
            if (e.getSource() == btnUpdate) {
                ...
                String Id = txtEmployeeID.getText().toUpperCase();

                String update = " update employees set full_name ='" + name + "', email = '" + email + "', mobile='" + mobile + "', gender='" + gender + "'," +
                        "job_title='" + jobTitle + "'  where employee_id = '" + Id + "' ";
